...
namespace UsersService.Tests.Unit.Companies
{
    public class AddCompanyCommandTests
    {
        ...
        public async Task ShouldAdd_WhenCompanyValid()
        {
            ...
            unitOfWorkMock.Setup(u => u.UsersRepository.GetByIdAsync(command.UserId)).ReturnsAsync(userEntity);
            ...
            unitOfWorkMock.Verify(
                u => u.UsersRepository.GetByIdAsync(command.UserId),
                Times.Once,
        ...
        public async Task ShouldThrowEntityNotFoundException_WhenUserForCompanyNotExist()
        {
            ...
            unitOfWorkMock.Setup(u => u.UsersRepository.GetByIdAsync(command.UserId)).ReturnsAsync((UserEntity)null);
